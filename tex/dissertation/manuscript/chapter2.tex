...
$$
O_{CPS}\ ,\ System\ {F}\ ,\ System\ {F_\omega}
$$
...
своїм синтаксичним деревом, або індуктивним типом:
\begin{lstlisting}
data CPS = var (x: nat)
         | lam (l: nat) (d: cps)
         | app (f a: cps)
...
Кожна мова програмування анонсує систему типів згідно свого
індуктивного синтаксичного дерева. Усі можливі екземпляри цього
синтаксичного дерева є усіма можливими программами в цій мові
програмування. Морфізми мовних категорій --- правила виводу, компіляції, верифікації.
...
X: maybe\ MLTT \\
type,norm: X \rightarrow X \\
certify: X \rightarrow X = type \circ norm \\
\end{cases}
$$
\end{definition}

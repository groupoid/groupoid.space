...
\end{split}
\end{equation}
наступним чином. Кожна наступна мова програмування залежить
...
\begin{equation}
O_{System} : O_{CPS} \rightarrow O_{PTS} \rightarrow O_{MLTT} \rightarrow O_{ITS} \rightarrow O_{HTS} \rightarrow U.
\end{equation}
\end{definition}
...
\begin{figure}[h]
  \centerline{\includegraphics[scale=0.5]{full.eps}}
  \caption{Кубічна та чиста система типів та два інтерпретатори}
\end{figure}

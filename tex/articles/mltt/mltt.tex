...
presented in cubical syntax and type checked by cubicaltt. Also landspace of possible
interpretation was shown corresponding different mathematical theories.
...
{\bf Issue XI: K-Theory}. K-Theory.
This issue covers following modules: k\_theory, spawptrans, subtype, bishop.
...
repository\footnote{\url{https://github.com/groupoid/om}}.

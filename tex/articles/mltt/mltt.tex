...
\title{Types I: Internalizing Martin-Löf Type Theory}
...
The article names may subject to change and are based on course structure.
A number of articles could be issued under the same chapter number.

{\bf Types I: Intenalizing Martin-Löf Type Theory}.
...
{\bf Types II: Inductive Types and Encodings}.
...
{\bf Types III: Fibrations and $\infty$-groupoids}.

{\bf Types IV: Set Theory}.
The basic theorems about set theory and higher groupoids: hedberg, girard, prop, set.

{\bf Types V: Many Faces of Equality}.
...
{\bf Types VI: Higher Inductive Types}.
The metamodel of HIT is a theory of CW-complexes. The category of HIT is a homotopy category.
Modules: cw.

{\bf Types VII: Modalities}. Modules: infinitesimal, process.

{\bf Types VIII: Category Theory}.
The model of Category Theory definitions. It includes:
cat, adj, cones, fun, category, sip, ump, cwf.

{\bf Types IX: Formal Topos on Category of Sets}.

{\bf Types X: Abstract Algebra}.
Abstract algebra, such as Monoid, Group, Semigroup, Monad, etc: algebra, control.

{\bf Types XI: Ordinals}.
Modules: ordinal, mahlo.

{\bf Types XII: Differential Geometry}.
Modules: etale, infinitesimal, manifold, shape.

{\bf Types XIII: Hopf Fibrations}.
Modules: pointed, euler, hopf.

{\bf Types XIV: K-Theory}.

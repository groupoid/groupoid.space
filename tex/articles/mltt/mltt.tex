...
\title{\small Максим Maxim Sokhatsky^{1}}
...
As types in Martin-Löf Type Theory\cite{Lof72}\cite{Lof75}\cite{Lof84} (MLTT) are formulated using 5 types of rules (formation,
...
prover was presented\cite{Mortberg17}. We should not that this is only entrance
to internalization technique, and after formal MLTT embedding we
need to go further through CiC\cite{Pfenning89}\cite{Dybjer94} and towards CW-complexes
embedding as the higher inductive type system. This is yet open problem.

...
\begin{document}
\title{Languages I: Pure Type System for Erlang}
...
\begin{figure}[h]
  \centerline{\includegraphics[scale=0.28]{structure}}
...
\hline
{\bf Target Language} & {\bf Class} & {\bf Higher Language} & {\bf Type Theory}\\
\hline
...
\begin{figure}[h]
  \centerline{\includegraphics[scale=0.28]{stages}}

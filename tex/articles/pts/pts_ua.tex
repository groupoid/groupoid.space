...
мову проміжного рівня для застосунку у додадках з підвищеними вимогами до якості математичної верифікації.
...
та покажемо місце цієї мови у конценптуальній системі доведення теорем, яка передбачає поєднання: 1) оптимальної лямбда обчислювача;
2) мова з однією аксіомою; 3) MLTT мова; 4) мова з гомотопічними типами та інтервалом.
\end{abstract}

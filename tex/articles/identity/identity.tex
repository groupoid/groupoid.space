...
At the moment only two provers that support CTT exists, this is Agda and Cubical \cite{Mortberg17}.
We developed a base library for cubical type checkers and described the approach
of how to deal with heterogeneous equalities by the example of proving Iso(Nat,Fix(Maybe)).
...
The amount of code needed for Iso(Nat,Fix(Maybe)) proof is around 400 LOC in modules.

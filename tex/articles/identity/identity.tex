...
based on MLTT such as Coq, Agda, Cubical, Idris. In the article we will use Cubical language.
...
Pi has one lambda function constructor, and its eliminator, the application \cite{HoTT, Lof72, Lof84, Hofmann86, Mortberg17, Ulf09}.
...
Sigma has one pair constructor and two eliminators, its projections. \cite{HoTT}
...
not derivable in MLTT. \cite{HoTT}

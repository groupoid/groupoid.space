...
The demonstarted program could be seen in Om project \footnote{https://github.com/groupoid/om/blob/master/priv/normal/Morte/recursive}.
...
The infinity IO sample is also provided by Om project \footnote{https://github.com/groupoid/om/blob/master/priv/normal/Morte/corecursive}
...
In other articles there will be coverage of the folliwing
sections of modules: 1) Equivalence;
2) Isomorphism;
3) Univalence;
4) Categories with Families;
5) Quotients and Retract;
6) Circle and Interval.

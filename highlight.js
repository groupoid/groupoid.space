function highlight() {
    ...
    for (var i = 0; i < code.length; i++) {
        code[i].innerHTML = code[i].innerHTML
            ...
            .replace(/\b(data|transp|Anders|prover|MLTT|PTS|CCHM|HTS|hcomp|where|def|mutual|begin|end|module|import|option|false|true|.1|.2|Pi|Sigma|Path|Type|Prop|inductive|record|forall|fun|match|let|axiom|theorem|in|U|S|V)\b(?!:)/g,

...
We briefly describe the top-level language $\mathbf{Christine}$ which extends PTS core with general induction, sigma and equality as the further work.
...
As a full vision we propose a stack of langauges, where {\bf Henk} takes an initial part.
\end{abstract}

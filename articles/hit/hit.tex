...
The suspension $\Sigma A$ of a type $A$ is a higher inductive type (HIT) that
...
\subsection{Pushout}
The pushout is a higher inductive type (HIT) that constructs a type by
...
the pushout $\text{pushout } A B C f g : \mathcal{U}$.
\end{definition}
...
The Hub and Spoke construction defines $n$-truncations,

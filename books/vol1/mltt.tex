...
MLTT-73 and its internalization with $\eta$-rule for identity types due to gropoid interpretation
...
In 1973, a variant MLTT-73 with $\mathrm{Id}$ types was introduces.
...
proofs of MLTT-75’s rules, including the J eliminator.

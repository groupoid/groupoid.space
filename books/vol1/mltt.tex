...
The MLTT-75 without Sum Types (+) and Natural Numbers ($\mathbb{N}$) we will
...
Note that MLTT-75 internalization includes only eliminator and computational rule (without uniquness rule)

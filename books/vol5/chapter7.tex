...
{\textbf{Examples}}: Zariski, flat, étale, Nisnevich topologies.
...
\begin{definition} (Presheaf Category, {\textbf{PSh}}).
Presheaf category {\textbf{PSh}} for a site $\mathrm{C}$ is category
...
\begin{definition} (Sheaf Category, {\textbf{Sh}}).
Sheaf category {\textbf{Sh}}
...
of category of presheaves {\textbf{PSh}}.
\end{definition}

\begin{definition} (Grothendieck Topos).
Topos is the category of sheaves {\textbf{Sh}}$(C,J)$ on a site $\mathrm{C}$ with topology $J$.
\end{definition}
...
$$
    f : {\textbf{Sh}}(C) \rightarrow {\textbf{Sh}}(D)
$$
consist of functors $f_* : {\textbf{Sh}}(C) \rightarrow {\textbf{Sh}}(D)$ and
$f^* : {\textbf{Sh}}(D) \rightarrow {\textbf{Sh}}(C)$ such that $f^*$ is
...
and proved that {\textbf{Set}} is cartesian closed, has object classifier and thus a topos.

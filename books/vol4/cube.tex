...
\noindent \textbf{Fibrations}:
\begin{itemize}
\item \text{Functional Spaces} ($\mathbf{\Pi}$)
\item \text{Contextual Spaces} ($\mathbf{\Sigma}$)
\end{itemize}

\noindent \textbf{Identification Systems}:
\begin{itemize}
\item \text{Strict Equality} ($\mathbf{=}$)
\item \text{Path Spaces} ($\mathbf{\equiv}$)
\item \text{Homotopy} ($\mathbf{\sim}$)
\item \text{Bisimulation} ($\mathbf{\approx}$)
\item \text{Equivalence} ($\mathbf{\simeq}$)
\item \text{Isomorphism} ($\mathbf{\cong}$)
\item \text{Gluing} ($\mathbf{Glue}$)
\end{itemize}

\noindent \textbf{Polynomials}:
\begin{itemize}
\item \text{Pretopos Induction} ($\mathbf{W}$)
\item \text{Pretopos Coinduction} ($\mathbf{M}$)
\item \text{Higher Induction} ($\mathbf{HIT}$)
\item \text{Higher Coinduction} $\mathbf{CoHIT}$)
\end{itemize}
...
\noindent \textbf{Localizations}:
\begin{itemize}
\item \text{Spectra} ($\mathbf{Sp}$)
\item \text{Local} ($\mathbb{A}^1$)
\item \text{Simplicial} ($\mathbb{\Delta}^n$)
\item \text{Super} ($\mathbb{Z}_2$)
\end{itemize}

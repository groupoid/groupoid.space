...
% Algebra and Geometry Layer
    ...
    Issue XXXVII: Homotopical Dynamics (Kac) \\
% Modal Layer
    \vspace{-2mm} \rule{\textwidth}{0.4pt}
    ...
    Issue XLVI: Colored Spectra (Tonpa) \\
    Issue XLVII: Transpension Types (Nuyts) \\
    \vspace{-2mm} \rule{\textwidth}{0.4pt}
    \centering
    \vfill
    \large
...
\newpage \begin{standalone} \input{functional} \end{standalone}    % 36
% Modal
...
\newpage \begin{standalone} \input{colored} \end{standalone}       % 45
\newpage \begin{standalone} \input{transpension} \end{standalone}       % 47
\end{document}

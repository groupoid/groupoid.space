...
\title{Issue XXVII: Models of Type Theory}
...
\subsubsection{Категорії з сім'ями}
...
\subsubsection{Семантика залежної теорії типів}
...
\newpage
\subsubsection{Формалізація в Anders}

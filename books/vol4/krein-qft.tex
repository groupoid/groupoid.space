...
\section{Indefinite-Metric Quantum Field Theory}
\label{sec:qft}

\subsection{Foundations of Krein Spaces}
...
\subsubsection{Fundamental Symmetry $J$}
...
\subsection{Operator Classification and Ghost Parity $\mathbb{Z}_2$}
\label{sec:operators}
...
\subsection{Ostrogradsky Instability and CPT Reinterpretation}
...
\section{Modal Homotopy Type Theory Formalization}
\label{sec:mhot}

\subsection{Ghost Parity via Flat Modality $\flat$}
\label{sec:flat}
...
\subsection{Fundamental Symmetry and Krein Space Structure}
...
\subsection{Krein Trace via Sharp Modality $\sharp$}
\label{sec:trace}
...
\subsection{Density Operators and Generalized Born Rule}
\label{sec:born}
...
\subsubsection{Generalized Born Rule}
...
\subsection{Fundamental Decomposition and Ghost Sector Decoupling}
...
\subsubsection{Ghost Decoupling Theorem}
...
\subsection{Physical Observables and Infrared Limit}
